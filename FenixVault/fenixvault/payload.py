...
def _write_readme(backup_dir: str, info: BackupInfo) -> str:
    ...
    lines = [
        ...
        "------------------------------------",
        "If REBUILD-THIS-PC.html is in this folder, open it. It is a single",
        "web page holding pictures of the desktop as it was, the list of",
        "installed programs, printer names and addresses, Wi-Fi profiles,",
        "network settings and your Windows preferences. Read it on a phone",
        "while you set the machine up again.",
        "",
        "It may contain Wi-Fi passwords, a BitLocker recovery key and your",
        "Windows product key. Keep this drive somewhere safe.",
        "",
        "WHAT ELSE IS IN HERE",
        "--------------------",
        "  Data\\               your files, in their original folder structure",
        "  REBUILD-THIS-PC.html how this computer was set up",
        "  SystemSnapshot\\      screenshots, Wi-Fi profiles, registry exports",
